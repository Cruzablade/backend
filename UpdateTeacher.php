...
<!-- Code Begins here, front end above was sampled but changed accordingly-->
        <form method="post" action="UpdateTeacher.php">
          <label>Enter Teacher ID to Update:</label>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Teachers SET Teacher_name='$Tname', Teacher_address='$Addr', Email='$Email', `Phone number`='$Num', Salary='$Sal', Class_Id='$Cid' WHERE Teacher_id='$Tid';";
