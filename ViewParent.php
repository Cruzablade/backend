...
<!-- Code Begins here, front end above was sampled but changed accordingly-->
        <table>
            <tr>
                ...
                <th width="250px">Parent of student ID<br><hr></th>
            </tr>

<?php

$sql = mysqli_query($link, "SELECT Parent_id, Parent_name, Parent_address, `Phone number`, Pupil_id FROM `Parents/Guardians`");
