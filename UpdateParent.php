...
<!-- Code Begins here, front end above was sampled but changed accordingly-->
        <form method="post" action="UpdateParent.php">
          <label>Enter Parent ID to Update:</label>
          ...
          <br><br>
          <label>Student ID they're a parent of:</label>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `Parents/Guardians` SET Parent_name='$Pname', Parent_address='$Addr', `Phone number`='$Num', Pupil_id='$Sid' WHERE Parent_id='$PID';";
